...
namespace Decsys.Controllers
{
    ...
    public class ParticipantProgressController : ControllerBase
    {
            ...
            GetProgress(string friendlyId, string? participantId)
        {
            ...
            if (progress.ParticipantId is not null)
            {
                ...
                if (hasCompleted)
                {
                    ...
                    if (!instance.OneTimeParticipants)
                    {
                        ...
                        progress.NewParticipantId = instance.UseParticipantIdentifiers
                            ? _events.GetNextId(progress.ParticipantId, instanceId)
             ...
             *         Y      |      Y      |       Y      | Send back new server updated ID - Survey complete and repeatable but no progress yet (expect a second request with known id)
             */
