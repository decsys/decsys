...
namespace Decsys.Repositories.Contracts
{
    public interface ISurveyRepository
    {
        ...
        PagedSurveySummary List(string? userId = null, bool includeOwnerless = false, string? name = null, string view = "", string sortBy = SurveySortingKeys.Name, string direction= SurveySortingKeys.Direction, bool isStudy = false, int pageIndex = 0, int pageSize = 10);
