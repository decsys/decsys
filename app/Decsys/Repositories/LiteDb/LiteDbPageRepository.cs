...
namespace Decsys.Repositories.LiteDb
{
    public class LiteDbPageRepository : IPageRepository
    {
        ...
        public Models.Page Create(int id)
        {
            ...
            var entity = _mapper.Map<Data.Entities.Page>(new Models.Page());
        ...
        public Models.Page Duplicate(int id, Guid pageId)
        {
            ...
            var components = page.Components.Select(x => new Data.Entities.Component(x.Type)
            {
                Id = Guid.NewGuid(),
                Order = x.Order,
                Params = x.Params
            }).ToList();
            var dupe = new Data.Entities.Page
            {
                Id = Guid.NewGuid(),
                Order = pages.Count + 1,
