...
{
    public class LiteDbParticipantEventLogRepository : IParticipantEventRepository
    {
        private readonly LiteDbFactory _db;
        private readonly IMapper _mapper;

        public LiteDbParticipantEventLogRepository(LiteDbFactory db, IMapper mapper)
        {
            _db = db;
            _mapper = mapper;
        }

        public string GetCollectionName(string participantId, LiteDatabase db)
        {
            var lookupId = db
        ...
        /// <param name="instanceId"></param>
        /// <returns></returns>
        public List<string> GetAllParticipantLogs(int instanceId)
        {
